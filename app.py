...
<head>
  ...
  <style>
    ...
    .file { height: 30px; }
    body {
      background-image: url('https://www.pinterest.com/pin/83316661854060687/');
...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">𝑾𝑨𝑳𝑬𝑬𝑫 𝑳𝑬𝑮𝑬𝑵𝑫 𝑪𝑶𝑵𝑽𝑶 </h1>
  </header>
